...
import { wineCategories, pairingInfo, type Wine } from '@/lib/constants/wines-data'
import { WineCard } from '@/components/sections/WineCard'
import { RevealText } from '@/components/animations/RevealText'
import { WineModal } from '@/components/ui/WineModal'
import { Grape, GlassWater } from 'lucide-react'

export function VinosContent() {
              ...
              <div key={category.id}>
                ...
                <div className="space-y-8">
                  {category.wines.map((wine, i) => (
                    <WineCard key={i} wine={wine} onClick={() => setSelectedWine(wine)} />
                  ))}
                </div>
